...
SECRET_KEY = 'django-insecure-+i1a1+wqmf048*(vja7gtgq#n6+s82jx89u#=7x76qx#(*3zr#'
...
ALLOWED_HOSTS = ["localhost", "127.0.0.1","rousan-chandra-ikearousan.pbp.cs.ui.ac.id","10.0.2.2"]
